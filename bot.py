    ...
    try:
        ...
        if img_path and os.path.exists(img_path):
            ...
            try:
                ...
                # Check IS_POSTGRES via global or check connection type, but get_db_connection 
                # abstracts this. However, raw byte handling might differ.
                # SQLite returns bytes, Postgres returns memoryview or bytes.
